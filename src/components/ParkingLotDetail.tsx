      ...
      setEntries(
        entries.map((e) =>
          e.id === checkoutEntry.id
            ? {
                ...e,
                exit_time: updated.fechaSalida,
                amount_paid: updated.tarifa,
                total: updated.total,
              }
            : e,
        ),
    ...
    <div className="p-8 space-y-8">
      <div className="flex items-center space-x-4">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-orange-700 to-orange-500 hover:from-orange-500 hover:to-yellow-500 text-white font-bold rounded-lg shadow-lg shadow-orange-500/30 transition-all"
        >
      ...
      {showAddForm && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-zinc-900 border-2 border-orange-500/30 rounded-lg p-8 max-w-md w-full relative">
            ...
            <h2 className="text-2xl font-bold text-orange-400 mb-6 tracking-wide">
              REGISTRAR VEHÍCULO
            </h2>
      ...
      <div className="space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-orange-400 mb-4 tracking-wide">
            VEHÍCULOS ACTIVOS
          </h2>
          {activeEntries.length === 0 ? (
            <div className="bg-zinc-900/50 border-2 border-orange-500/20 rounded-lg p-8 text-center">
              ...
              <p className="text-gray-400">
                No hay vehículos actualmente estacionados
              </p>
            </div>
          ) : (
        ...
        <div>
          ...
          {completedToday.length === 0 ? (
            ...
            <div className="space-y-3">
              <div className="flex justify-end text-yellow-400 font-bold text-lg mb-2"></div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">
                        ...
                        {entry.exit_time && formatDateTime(entry.exit_time)}
                      </p>
                      ...
                      <p className="text-xs text-green-400">
                        Total:{" "}
                        {!isNaN(Number(entry.total))
                          ? `$${Number(entry.total).toFixed(0)}`
                          : "-"}
                      </p>
                    </div>
                  </div>
